            ...
            <div className='footer'>
                ...
                <div className="col-6">
                    ...
                    <div className="d-flex">
                        <a className='icons' href="/"><i className='fab fa-twitter fw-normal'></i></a>
                        <a className='icons' href="/"><i className='fab fa-facebook-f fw-normal'></i> </a>
                        <a className='icons ' href="/"><i className='fab fa-linkedin-in fw-normal'></i></a>
                        <a className='icons' href="/"><i className='fab fa-youtube fw-normal'></i></a>
                    </div>
                </div>
            </div>
            <hr />
